...
async function pnVerifyStellar() {
  ...
  action.innerHTML = `<div class="pn-bc-spinner"></div><p style="color:#64748b;font-size:13px">Generating SHA-256 hash...<br><small>Broadcasting to Stellar Testnet...</small></p>`;
  const region = pnCurrentRegion;
  ...
  setTimeout(() => {
    action.innerHTML = `
      ...
      <h3 style="font-size:1.2rem;font-weight:800;color:#4ade80;margin-bottom:8px">Stellar Network Verified!</h3>
    ...
    document.getElementById('pn-bc-meta-rows').innerHTML = [
      ...
      ['Walls Hashed', wallsArr.length + ' walls'],
